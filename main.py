...
fig_sales_month.update_xaxes(title_font_size=20,
                            tickfont_size=18,
)
...
fig_sales_product_line.update_yaxes(tickfont_size=16,
                                    title_font_size=16,
)

fig_sales_product_line.update_xaxes(title_font_size=20,
                                    tickfont_size=15,
)

# situar las graficas en dos columnas 

left, right = st.columns(2)

left.plotly_chart(fig_sales_month)
right.plotly_chart(fig_sales_product_line)
...
fig_group_city_gender.update_xaxes(title_font_size=20,
                                   tickfont_size=18,
)

fig_group_city_gender.update_layout(title_x=0.4,
                                    title_font_size=25,
...
fig_total_branch_payment.update_xaxes(title_font_size=20,
                                      tickfont_size=18,
)

fig_total_branch_payment.update_layout(title_x=0.4,
                                       title_font_size=25,
                                       legend_title_font_size=16,
                                       legend_font_size=16,
                                       font_size=18,
...
left2.plotly_chart(fig_group_city_gender)
right2.plotly_chart(fig_total_branch_payment)
...
fig_evolution_branch.update_layout(title_x=0.4,
                                   title_font_size=25,
                                   legend_title_font_size=16,
                                   legend_font_size=16,
                                   font_size=18,
...
fig_evolution_branch.update_yaxes(tickfont_size=16,
)

fig_evolution_branch.update_xaxes(title_font_size=20,
                                  tickfont_size=18,
)

fig_evolution_branch.update_traces(textposition='top center',
                                   marker_size=10,
)
...
fig_spend_gender.update_layout(title_x=0.4,
